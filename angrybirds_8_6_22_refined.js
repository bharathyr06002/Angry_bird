...
function preload() {
    ...
    BACKGROUND_TRACK = loadSound('data/background_track_3.mp3');
...
function setup(){
    ...
    world = engine.world;
    initialize();
    groundObject = new groundClass(SCREEN_WIDTH/2,SCREEN_HEIGHT -25 ,SCREEN_WIDTH,50);
    
    platForm = new groundClass(125, SCREEN_HEIGHT - 75, 250, 150);
